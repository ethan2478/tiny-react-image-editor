...
export default function Ellipse (): ReactElement {
  ...
  const deselectEllipse = useCallback(() => {
  ...
  }, [checked, selectEllipse, historyDispatcher, deselectEllipse])
  ...
  return (
    <OperationButton
      ...
      option={<SizeColor size={size} color={color} onSizeChange={setSize} onColorChange={setColor} />}
    />
  )
}
